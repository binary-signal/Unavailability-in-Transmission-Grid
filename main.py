...
if __name__ == "__main__":
    ...
    try:
        # fetch data
        data = entsoe.transmission_grid_unavailability(from_date, to_date,
                                                       country=country,
        ...
        fetched from the api, Great ? YEAH !
            ...
            days_to_fetch: specify how many days worth of data to fetch, a day is
                            60 datapoints. e.g. days_to_fetch=2 fetches  120 data
                            points and ignores the rest time series data.
